...
# These results are obtained by compile and running the C code (check mt19937.c  for reference)
# I print mt[] after init_by_array() to obtain the state
path_to_random_helper = "tools/random_helper/{}"
...
def test_MT19937():
    # Test 3 things. If all passes, then the MT19937 implementation should be correct
    ...
    print("All 3 tests passes! The MT19937 seems correctly implemented!")
